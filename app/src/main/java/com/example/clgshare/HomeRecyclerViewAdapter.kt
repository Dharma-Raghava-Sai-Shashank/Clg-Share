...
class HomeRecyclerViewAdapter:RecyclerView.Adapter<HomeRecyclerViewAdapter.ViewHolder>(){
    ...
    private var myPostDataList=ArrayList<MyPostData>()
...
//    var appViewModel: AppViewModel? = null
    ...
    override fun onBindViewHolder(holder: HomeRecyclerViewAdapter.ViewHolder, position: Int) {
        val myPostData=myPostDataList.get(position)
...
////                        appViewModel?.insertFavouriteData(
////                            MyFavouriteData(
////                                myPostData.uid,
////                                myPostData.image,
////                                myPostData.subject,
...
////                    appViewModel?.insertConnectionData(
...
//        })
    ...
    fun updatePostData(myPostDataList:ArrayList<MyPostData>){
        this.myPostDataList.clear()
        this.myPostDataList.addAll(myPostDataList)
    ...
    class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            Suject = itemView.findViewById(R.id.Subject)
