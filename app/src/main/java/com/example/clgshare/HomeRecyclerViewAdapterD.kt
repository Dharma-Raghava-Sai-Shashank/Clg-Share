...
class HomeRecyclerViewAdapterD(options: FirebaseRecyclerOptions<Data>) :
    FirebaseRecyclerAdapter<Data, HomeRecyclerViewAdapterD.ViewHolder>(options) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int, myPostData: Data) {
